    ...
    <div class="ibox-body">
		<form method="post" id="form-validation" action="javascript:;" novalidate="novalidate">
			<div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="nm_simpanan" placeholder="Jenis Simpanan" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
...
<script type="text/javascript">
    $(document).ready(function (){
        $("#form-validation").validate({
            ...
            messages:{
                nm_simpanan:{
                    required:"Nama Jenis simpanan harus diisi"
                },
            },
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type: "POST",
                    url : "<?= base_url('admin/savejenissimpanan')?>",
                    data: {<?= csrf_token() ?>:'<?= csrf_hash() ?>',nm_simpanan:nm_simpanan},
