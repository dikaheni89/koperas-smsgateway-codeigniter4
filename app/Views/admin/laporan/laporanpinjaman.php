      ...
      <div class="ibox-body">
        <table id="dgGrid"
          style="min-height: 1020px;"
            ...
            rowNumbers="true" 
            pagination="true" 
            url="<?= base_url('admin/getlaporanpinjaman') ?>" 
            pageSize="15" 
            ...
            groupFormatter:function(value,rows){
              ...
              <thead>
                  <tr>
                      ...
                      <th field="nominal_pinjam" width="30%">Jumlah Pinjaman</th>
                      <th field="total_angsuran" width="30%">Jumlah Angsuran</th>
                  </tr>
              </thead>
          </table>
        ...
        <div id="toolbar" style="padding: 10px">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a href="javascript:void(0);" class="btn btn-info" onclick="doPrint('<?= base_url(); ?>/admin/laporanpinjamanpdf')"><i class="fas fa-eye"></i> Lihat Total Pinjaman</a>
                </div>
            </div>
        </div>
      </div>
