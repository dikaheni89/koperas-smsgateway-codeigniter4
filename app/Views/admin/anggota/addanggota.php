        ...
        <div class="ibox-body">
            <form method="post" id="form-anggota" action="javascript:;" enctype="multipart/form-data" novalidate="novalidate">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="number" name="no_identitas" id="no_identitas" placeholder="Nomor Identitas (KTP, SIM, PASPORT)" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Nama Lengkap</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="nm_anggota" id="nm_anggota" placeholder="Nama Anggota" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input class="form-control" type="text" name="alamat" id="alamat" placeholder="Alamat Lengkap" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">No. Telp</label>
                    <div class="col-sm-6">
                        <input class="form-control" type="number" name="no_telp" id="no_telp"  placeholder="Nomor Telp" autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input class="form-control" type="text" name="tgl_masuk" placeholder="Tanggal Menjadi Anggota" id="tgl_masuk" autocomplete="off">
                    </div>
                </div>
                <div class="form-group row">
    ...
    $(document).ready(function (){  
        $("#form-anggota").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type: "POST",
                    url : "<?= base_url('admin/saveanggota')?>",
                    async:false,
